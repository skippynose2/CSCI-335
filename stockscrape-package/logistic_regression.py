...
# Getting the target variable, splitting it into test and validation set and testing with validaiton and testing data
for x in range(1, 4): # x will be 1, 2 and 3
    ...
    print(f"Accuracy on validation set: {accuracy_score(y_validation.astype(int), validation_predictions) * 100}")

    test_predictions = logistic_model.predict(x_test)
    print(f"Accuracy on test set: {accuracy_score(y_test.astype(int), test_predictions) * 100}")
